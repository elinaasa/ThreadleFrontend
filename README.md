...
[Link to Threadle](https://users.metropolia.fi/~veetiso/vuosi3/Threadle/)

[Link to Backend](https://github.com/Vege25/threadle-backend)

[Link to API-docs](https://users.metropolia.fi/~veetiso/vuosi3/Threadle-docs/)

## API
### http://10.120.32.52/
### /media, /uploads ja /auth
## ...
